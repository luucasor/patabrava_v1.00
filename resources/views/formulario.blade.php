    ...
    <div class="row">
      <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="form-group thumbnail">
          ...
          <figure align="center">
            <img class="img-rounded" name="img1" id="img1" src="https://cdn2.iconfinder.com/data/icons/social-media-8/512/image2..png" height="150" width="200" alt="Prévia da imagem1...">
      ...
      <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="form-group thumbnail">
          ...
          <figure align="center">
            <img class="img-rounded" name="img2" id="img2" src="https://cdn2.iconfinder.com/data/icons/social-media-8/512/image2..png" height="150" width="200" alt="Prévia da imagem2...">
      ...
      <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="form-group thumbnail">
          ...
          <figure align="center">
            <img class="img-rounded" name="img3" id="img3" src="https://cdn2.iconfinder.com/data/icons/social-media-8/512/image2..png" height="150" width="200" alt="Prévia da imagem3...">
